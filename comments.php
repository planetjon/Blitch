...
<?php if( have_comments() ) : ?>
	<h2 class="comments-heading heading">
		<?php
			printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'blitch' ),
	...
	<nav id="comment-nav-below" class="navigation" role="navigation">
		<h2 class="assistive-text section-heading"><?php _e( 'Comment navigation', 'blitch' ) ?></h2>
...
<?php
	...
	comment_form( array(
		'comment_field' => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun', 'blitch' ) . '</label><br/><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
